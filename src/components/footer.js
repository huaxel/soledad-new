            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-16 text-center md:text-left mb-20">
                ...
                <div>
                    ...
                    <div class="flex justify-center md:justify-start gap-4">
                        <a href="https://www.facebook.com/haciendalasoledadeventos" target="_blank" class="w-10 h-10 rounded-full border-2 border-gray-600 text-gray-800 flex items-center justify-center hover:border-hacienda-gold hover:text-hacienda-gold hover:bg-hacienda-gold/10 transition-all duration-300" aria-label="Facebook">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.77,7.46H14.5v-1.9c0-.9.6-1.1,1-1.1h3V.5h-4.33C10.24.5,9.5,3.44,9.5,5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4Z"/></svg>
                        </a>
                        <a href="https://www.instagram.com/haciendalasoledad/" target="_blank" class="w-10 h-10 rounded-full border-2 border-gray-600 text-gray-800 flex items-center justify-center hover:border-hacienda-gold hover:text-hacienda-gold hover:bg-hacienda-gold/10 transition-all duration-300" aria-label="Instagram">
                        ...
                        <a href="https://www.linkedin.com/company/hacienda-la-soledad/" target="_blank" class="w-10 h-10 rounded-full border-2 border-gray-600 text-gray-800 flex items-center justify-center hover:border-hacienda-gold hover:text-hacienda-gold hover:bg-hacienda-gold/10 transition-all duration-300" aria-label="LinkedIn">
                        ...
                        <a href="https://www.youtube.com/channel/UCoOcU_SM0ARrjQYFO_ZDm9w" target="_blank" class="w-10 h-10 rounded-full border-2 border-gray-600 text-gray-800 flex items-center justify-center hover:border-hacienda-gold hover:text-hacienda-gold hover:bg-hacienda-gold/10 transition-all duration-300" aria-label="YouTube">
